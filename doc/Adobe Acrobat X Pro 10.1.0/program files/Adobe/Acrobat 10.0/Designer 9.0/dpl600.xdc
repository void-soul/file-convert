...
<xdp:xdp xmlns:xdp="http://ns.adobe.com/xdp/">
	<xdc name="dpl600" id="dpl600" xmlns="http://www.xfa.org/schema/xdc/1.0/">
		<pdl>
		...
		<deviceInfo>
			...
			<option name="model">Datamax 600 DPI</option>
           ...
           <option name="supportsFontRasterizing">1</option>
			...
			<deviceUnits name="arcPlacement" hSize="0.042mm" vSize="0.042mm" fracDigits="0" fraction="round"/>
			<deviceUnits name="arcDimensions" hSize="0.042mm" vSize="0.042mm" fracDigits="0" fraction="round"/>
			...
			<barcodes>
				...
				<barcodeDefinition type="code11" support="hardware" wideNarrowRatio="2.0-3.0" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" checksum="auto,none" textLocation="none,below" validDataChars="0123456789-"/>
				<barcodeDefinition type="code2Of5Interleaved" support="hardware" wideNarrowRatio="2.0-3.0" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" checksum="auto,none" textLocation="none,below" validDataChars="0123456789"/>
				<barcodeDefinition type="code2Of5Industrial" support="hardware" wideNarrowRatio="2.0-3.0" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789"/>
				<barcodeDefinition type="code2Of5Standard" support="hardware" wideNarrowRatio="2.0-3.0" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789"/>
				<barcodeDefinition type="codabar" support="hardware" wideNarrowRatio="2.0-3.0" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" checksum="auto,none" textLocation="none,below" startChar="ABCDabcd*NTEnte" endChar="ABCDabcd*NTEnte" validDataChars="0123456789"/>
				<barcodeDefinition type="plessey" support="hardware" wideNarrowRatio="2.0-3.0" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" checksum="auto,none" textLocation="none,below" validDataChars="0123456789ABCDEF"/>
				<barcodeDefinition type="postUSStandard" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789 -" dataLength="9"/>
				<barcodeDefinition type="postUS5Zip" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789" dataLength="5"/>
				<barcodeDefinition type="postUSDPBC" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789 -" dataLength="11"/>
				<barcodeDefinition type="ean8" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" dataLength="7" validDataChars="0123456789"/>
				<barcodeDefinition type="upcE" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" printCheckDigit="1" validDataChars="0123456789" dataLength="10"/>
				<barcodeDefinition type="ean13" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789" dataLength="12"/>
				<barcodeDefinition type="upcean2" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789" dataLength="2"/>
				<barcodeDefinition type="upcean5" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789" dataLength="5"/>
				<barcodeDefinition type="upcA" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" printCheckDigit="1" validDataChars="0123456789" dataLength="11"/>
				<barcodeDefinition type="code3Of9" support="hardware" wideNarrowRatio="2.0-3.0" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" checksum="auto,none" textLocation="none,below" validDataChars="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -.$/+%"/>
				<barcodeDefinition type="code93" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" printCheckDigit="1" textLocation="none,below" validDataChars="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -.$/+%&amp;',()"/>
				<barcodeDefinition type="code128" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below"/>
				<barcodeDefinition type="code128A" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below"/>
				<barcodeDefinition type="code128B" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below"/>
				<barcodeDefinition type="code128C" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" textLocation="none,below" validDataChars="0123456789"/>
				<barcodeDefinition type="pdf417" support="hardware" wideNarrowRatio="fixed" moduleWidth="0.191mm-0.423mm" moduleHeight="0.042mm-4166mm" errorCorrectionLevel="012345678" dataColumnCount="1-30" dataRowCount="1-90" truncate="1"/>
